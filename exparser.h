...
/*!
  @typedef	std::pair<std::string, int> EXError
  @brief	Defines an alias representing the ex error .
*/
...
/**
 * This open source class is made by Justing Loundagin. It was found from
 * https://code.google.com/archive/p/exparser/
 */
class EXParser
{
    ...
    void priorityFormulaLoop(std::string &);
    void priorityOperatorLoop(std::string &);
    void priorityFunctionLoop(std::string &);
    void priorityLoop(std::string &);

    /* Evaluation methods */
    void evaluateOperator(std::string &, const int, EXOperatorSet::iterator);
    void evaluateFormula(std::string &, const int, EXFormulaSet::iterator);
    void evaluateFunction(std::string &, const int, EXFunctionSet::iterator);
    void evaluateParenthesis(std::string &, const int);
    ...
    std::string getRightOfOperator(const std::string, const int);
    std::string isolateParenthesisExpression(const std::string &, const int);
